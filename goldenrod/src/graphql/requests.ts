...
import { CreateEdgeDocument, CreateNodeDocument, DeleteNodeDocument, UpdateNodeDocument } from "./queries"
...
export const updateNode = (id: string) => {
  ...
  client.executeMutation(
    createRequest(UpdateNodeDocument, variables)
  ).then((val) => console.log("node updated", val),
...
export const createEdge = (srcId: string, destId: string) => {
  ...
  return client.executeMutation(
     createRequest(CreateEdgeDocument, variables)
  ).then((val) => console.log("edge created", val),
...
export const addNodeRequest = (x: number, y: number) => {
  ...
  return {
    ...
    execute: () => {
      return client.executeMutation(
        createRequest(CreateNodeDocument, variables)
      ).then((val) => console.log("created node", val),
...
export const executeDeleteNode = (id: string) => {
  return client.executeMutation(
    createRequest(DeleteNodeDocument, { id })
  ).then((val) => console.log("delete node", val),
